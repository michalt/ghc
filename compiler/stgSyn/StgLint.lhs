...
lintStgExpr (StgCase scrut _ _ bndr _ alts_type alts) = runMaybeT $ do
  ...
  where
    ...
    RepType scrut_rep = repType scrut_ty -- Not used if scrutinee is unboxed tuple
...
stgEqType orig_ty1 orig_ty2 
  ...
  where
    ...
    gos (UbxTupleRepType tys1) (UbxTupleRepType tys2)
      = equalLength tys1 tys2 && and (zipWith go tys1 tys2)
    gos (RepType ty1) (RepType ty2) = go ty1 ty2
    gos _ _ = False
